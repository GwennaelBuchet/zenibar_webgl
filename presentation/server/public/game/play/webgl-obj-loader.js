(function webpackUniversalModuleDefinition(root, factory) {
	...
	/******/({
		...
		/***/ (function (module, __webpack_exports__, __webpack_require__) {
			...
			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "MaterialLibrary", function () {
			...
			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "DuplicateAttributeException", function () {
			...
			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "downloadModels", function () {
				return _utils__WEBPACK_IMPORTED_MODULE_3__["downloadModels"];
			});

			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "downloadMeshes", function () {
				return _utils__WEBPACK_IMPORTED_MODULE_3__["downloadMeshes"];
			});

			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "initMeshBuffers", function () {
				return _utils__WEBPACK_IMPORTED_MODULE_3__["initMeshBuffers"];
			});

			/* harmony reexport (safe) */
			__webpack_require__.d(__webpack_exports__, "deleteMeshBuffers", function () {
...
// Material attributes
				   ...
				   */
					...
					for (let line of lines) {
						...
						if (VERTEX_RE.test(line)) {
							this.bbox.minx = Math.min(this.bbox.minx, elements[0]);
							this.bbox.miny = Math.min(this.bbox.miny, elements[1]);
							this.bbox.minz = Math.min(this.bbox.minz, elements[2]);
							this.bbox.maxx = Math.max(this.bbox.maxx, elements[0]);
							this.bbox.maxy = Math.max(this.bbox.maxy, elements[1]);
							this.bbox.maxz = Math.max(this.bbox.maxz, elements[2]);
							// if this is a vertex
							verts.push(...elements);
						}
				...
				calculateTangentsAndBitangents() {
					...
					for (let i = 0; i < indices.length; i += 3) {
						...
						const magTangent0 = Math.sqrt(
							x_resTangent0 * x_resTangent0 + y_resTangent0 * y_resTangent0 + z_resTangent0
							* z_resTangent0);
						const magTangent1 = Math.sqrt(
							x_resTangent1 * x_resTangent1 + y_resTangent1 * y_resTangent1 + z_resTangent1
							* z_resTangent1);
						const magTangent2 = Math.sqrt(
							x_resTangent2 * x_resTangent2 + y_resTangent2 * y_resTangent2 + z_resTangent2
							* z_resTangent2);
						// Bitangent
						...
						mtlPromise = fetch(mtl)
							...
							.then((data) => {
								...
								if (model.downloadMtlTextures !== false) {
									...
									return Promise.all(
										[Promise.resolve(material), downloadMtlTextures(material, root)]);
								}
		...
		/***/ (function (module, exports, __webpack_require__) {
			...
			module.exports = __webpack_require__(/*! /home/aaron/google_drive/projects/webgl-obj-loader/src/index.ts */
			                                     "./src/index.ts");
